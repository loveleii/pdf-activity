  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex justify-between">
        ...
        <a
          as="button"
          :href="'/clients/pdf/' + client.id"
          target="_blank"
          class="border border-gray-300 p-2 rounded shadow flex items-center space-x-1 hover:bg-gray-100 transition-colors"
        >
        ...
        <div class="bg-white p-4 rounded shadow w-[68%]">
          ...
          <table class="table table-auto min-w-[100%]">
            ...
            <tbody>
              ...
              <tr v-for="txn in client.transactions" :key="txn.id" class="hover:bg-gray-100 transition-colors">
                <td>{{ txn.date }}</td>
